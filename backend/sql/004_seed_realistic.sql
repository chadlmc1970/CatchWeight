...
-- ============================================================
INSERT INTO mbew (material_id, plant_id, price_control, standard_price, moving_avg_price, price_per_unit, valuation_class) VALUES
    -- Chicken - P100 (Arkansas Plant)
    ('CHKBRST-001', 'P100', 'V', NULL,  3.25, 3.25, '7920'),  -- $3.25/LB
    ('CHKWNG-002',  'P100', 'V', NULL,  2.10, 2.10, '7920'),  -- $2.10/LB
    ('CHKTHG-003',  'P100', 'S', 2.50,  NULL, 2.50, '7920'),  -- $2.50/LB
    ('CHKTND-006',  'P100', 'V', NULL,  4.10, 4.10, '7920'),  -- $4.10/LB
    ('CHKWHL-007',  'P100', 'V', NULL,  1.85, 1.85, '7920'),  -- $1.85/LB
    ('CHKNGT-012',  'P100', 'V', NULL,  5.50, 5.50, '7920'),  -- $5.50/LB
    ('CHKSKW-013',  'P100', 'V', NULL,  6.20, 6.20, '7920'),  -- $6.20/LB
    -- Chicken - P200 (Missouri Plant)
    ('CHKBRST-001', 'P200', 'V', NULL,  3.30, 3.30, '7920'),
    ('CHKWNG-002',  'P200', 'V', NULL,  2.15, 2.15, '7920'),
    -- Pork - P100
    ('PRKRIB-004',  'P100', 'V', NULL,  4.75, 4.75, '7930'),  -- $4.75/LB
    ('PRKCHP-008',  'P100', 'S', 3.80,  NULL, 3.80, '7930'),  -- $3.80/LB
    ('PRKSSG-009',  'P100', 'V', NULL,  2.95, 2.95, '7930'),  -- $2.95/LB
    -- Beef - P200
    ('BFGRD-005',   'P200', 'V', NULL,  5.20, 5.20, '7940'),  -- $5.20/LB
    ('BFSTRP-010',  'P200', 'S', 12.50, NULL, 12.50, '7940'), -- $12.50/LB
    ('BFPTTY-011',  'P200', 'V', NULL,  6.10, 6.10, '7940');  -- $6.10/LB
